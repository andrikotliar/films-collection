import { FieldLabel } from '~/lib/components/field-label/field-label';
import { monthOptions } from '~/lib/components/month-date-selector/configs';
import { Select } from '~/lib/components/select/select';
import styles from './styles.module.css';
import clsx from 'clsx';
import { getDateCode, getDateCodeParts, getDefaultDateCode, type FormError } from '~/lib';
import { FieldError } from '~/lib/components/field-error/field-error';
